...
const App = () => {
  ...
  const filteredImages = imagesList.filter(img => img.category === tab)
    ...
    <>
      ...
      {isGameOver ? (
        ...
        <div className="main-container">
          {/* MATCH IMAGE */}
          <img src={currentImage.imageUrl} alt="match" className="main-image" />
          ...
          <ul className="tab-container">
            {tabsList.map(tabItem => (
              <li
                key={tabItem.tabId}
                onClick={() => onChangeTab(tabItem.tabId)}
                className={tab === tabItem.tabId ? 'add' : ''}
              >
                {tabItem.displayText}
              </li>
            ))}
            ...
            {filteredImages.map(img => (
              <li key={img.id}>
                <img
                  ...
                  alt="thumbnail"
                  onClick={() => onThumbnailClick(img.id)}
                />
              </li>
            ))}
          </ul>
